...
const SingleProduct = ({ AddToCart }) => {
  ...
  const allProductGoBack = useNavigate();
  return (
    <>
      <div>
        ...
        <p
                  ...
                  onClick={() => allProductGoBack("/allproducts")}
                >
                  <svg
        ...
        <section className="text-gray-600 body-font overflow-hidden h-[80vh] flex items-center">
